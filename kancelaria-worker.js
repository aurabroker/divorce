...
var DEFAULT_CONFIG = DOMAIN_CONFIG["rozwod.waw.pl"];
var SUPABASE_URL = "https://kukvgsjrmrqtzhkszzum.supabase.co";
var SUPABASE_ANON = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imt1a3Znc2pybXJxdHpoa3N6enVtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI5MTI0NzYsImV4cCI6MjA4ODQ4ODQ3Nn0.wOB-4CJTcRksSUY7WD7CXEccTKNxPIVF8AT8hczS5zY";
var worker_default = {
...
async function handleLead(request, cfg, hostname) {
  ...
  try {
    ...
    if (!res.ok) {
      ...
      return jsonError(500, "B\u0142\u0105d zapisu \u2014 spr\xF3buj ponownie");
    }
...
<title>Opinie klient\xF3w | Kancelaria Idzik-Cieśla \xB7 ${cfg.district}</title>
...
<header class="nav">
  <div class="nav-inner">
    ...
    <nav class="nav-links nav-desktop" id="nav-desktop">
      <a href="/" class="nav-link">← Strona gł\xF3wna</a>
...
<section class="section" style="background:var(--accent-bg);border-bottom:1px solid rgba(0,0,0,.07);padding-top:clamp(3rem,6vw,5rem);padding-bottom:clamp(2rem,4vw,3.5rem);">
  <div class="container" style="text-align:center;max-width:680px;">
    ...
    <p style="color:var(--text-muted);font-size:1rem;line-height:1.7;max-width:520px;margin:0 auto;">Opinie naszych klient\xF3w pomagają innym znaleźć rzetelną pomoc prawną. Każda recenzja jest weryfikowana i publikowana ręcznie.</p>
  </div>
</section>
  ...
  <div class="container" style="max-width:620px;">
    <div class="form-card">
      <div id="form-inner">
        ...
        <div class="form-group"><label for="r-zawod">Zaw\xF3d (opcjonalnie)</label><input type="text" id="r-zawod" placeholder="np. inżynier, nauczyciel…"></div>
...
<section class="section" style="background:var(--accent-bg);border-top:1px solid rgba(0,0,0,.07);">
  <div class="container">
    <div class="section-header section-center text-center" style="margin-bottom:2rem;">
      <p class="section-label">Opinie klient\xF3w</p>
      <h2 class="section-title">Co m\xF3wią <em>nasi klienci</em></h2>
    </div>
  ...
  <div class="container">
    <div class="footer-grid">
      <div>
        ...
        <p class="footer-tagline">Dyskretna i skuteczna pomoc prawna. ${cfg.district} \xB7 Warszawa i Mazowieckie.</p>
...
document.getElementById('submit-btn').addEventListener('click',async()=>{
  ...
  try{
    ...
    fireConfetti();
  }catch(e){errEl.textContent='Błąd zapisu. Spr\xF3buj ponownie.';errEl.style.display='block';btn.disabled=false;btn.textContent='Wyślij opinię →';}
});
...
async function loadReviews(){
  ...
  try{
    ...
    if(!Array.isArray(rows)||!rows.length){grid.innerHTML='<div style="text-align:center;color:var(--text-muted);padding:2.5rem;border:2px dashed #ddd;border-radius:1rem;">Bądź pierwszą osobą, kt\xF3ra wystawi opinię!</div>';return;}
    grid.innerHTML=rows.map(r=>{
      ...
      return '<div class="testimonial" style="display:flex;flex-direction:column;">'+
        ...
        '<div class="t-meta">'+esc(r.city)+' \xB7 <span style="font-size:.72rem;background:var(--accent);color:#fff;padding:1px 7px;border-radius:10px;margin-left:3px;">'+esc(r.platform)+'</span></div>'+
        '</div></div></div>';
    }).join('');
...
<script type="application/ld+json">
{
  ...
  "@type": "FAQPage",
  "mainEntity": [
    {"@type":"Question","name":"Ile trwa sprawa rozwodowa?","acceptedAnswer":{"@type":"Answer","text":"Rozw\xF3d bez orzekania o winie trwa 3\u20136 miesi\u0119cy. Sprawy sporne z dzie\u0107mi i maj\u0105tkiem \u2014 rok lub d\u0142u\u017Cej."}},
    ...
    {"@type":"Question","name":"Czy mo\u017Cna si\u0119 skonsultowa\u0107 online?","acceptedAnswer":{"@type":"Answer","text":"Tak. Konsultacje przez Teams, Zoom lub telefon dla klient\xF3w z ca\u0142ej Polski. Pierwsza konsultacja bezp\u0142atna."}}
  ]
}
<\/script>
    ...
    <div class="hero-2col" style="display:grid;grid-template-columns:1fr 1fr;gap:3.5rem;align-items:center;">
      ...
      <div>
        <p class="hero-eyebrow" style="justify-content:flex-start;">
          ...
          Kancelaria Adwokacka \xB7 ${cfg.district} \xB7 Prawo Rodzinne
        </p>
        ...
        <p class="hero-sub" style="text-align:left;margin:0 0 2rem;max-width:100%;">
          Rozw\xF3d, podzia\u0142 maj\u0105tku, opieka nad dzie\u0107mi \u2014 przeprowadzimy Ci\u0119 przez ca\u0142y
          proces jasno, dyskretnie i po Twojej stronie.
        </p>
        <div class="hero-actions" style="justify-content:flex-start;margin-bottom:2rem;">
          <a href="#kontakt" class="btn btn-primary btn-lg">Um\xF3w bezp\u0142atn\u0105 konsultacj\u0119 \u2192</a>
          <a href="tel:+48605089552" class="btn btn-outline btn-lg">\u{1F4DE} 605 089 552</a>
        </div>
...
<div class="stats-bar">
  <div class="container">
    <div class="stats-inner">
      ...
      <div class="stat-item"><div class="stat-number" data-count="97" data-suffix="%">97%</div><div class="stat-label">Klient\xF3w poleca dalej</div></div>
...
<div class="location-strip">
  <div class="container">
    <div class="location-strip-inner">
      ...
      <span class="location-chip"><svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>Legionowo \xB7 \u0141omianki \xB7 online</span>
    </div>
  </div>
</div>
    ...
    <div class="pain-grid">
      <div>
        <div class="section-header">
          ...
          <h2 class="section-title">To jeden z najtrudniejszych moment\xF3w.<br><em>Nie musisz</em> przez to przechodzi\u0107 sam.</h2>
        ...
        <div class="pain-items">
          <div class="pain-item"><div class="pain-icon">\u2696\uFE0F</div><div><h4>Nie wiem od czego zacz\u0105\u0107</h4><p>Wyja\u015Bniamy ka\u017Cdy krok po ludzku \u2014 bez \u017Cargonu, bez ukrytych koszt\xF3w.</p></div></div>
          <div class="pain-item"><div class="pain-icon">\u{1F3E0}</div><div><h4>Obawiamy si\u0119 o mieszkanie i maj\u0105tek</h4><p>Zadbamy o sprawiedliwy podzia\u0142 \u2014 nieruchomo\u015Bci, oszcz\u0119dno\u015Bci, firma, kredyt.</p></div></div>
          <div class="pain-item"><div class="pain-icon">\u{1F476}</div><div><h4>Dzieci s\u0105 dla mnie najwa\u017Cniejsze</h4><p>Pomagamy ustali\u0107 plan wychowawczy zabezpieczaj\u0105cy dobro dzieci i Tw\xF3j realny kontakt.</p></div></div>
          <div class="pain-item"><div class="pain-icon">\u{1F91D}</div><div><h4>Chc\u0119 to zako\u0144czy\u0107 polubownie</h4><p>Mediacja jest cz\u0119sto szybsza i ta\u0144sza. Wspieramy ugodowe rozwi\u0105zania gdzie to mo\u017Cliwe.</p></div></div>
        </div>
      </div>
      <div>
...
<section class="section" style="background:var(--bg-card);">
  <div class="container">
    <div class="section-header section-center text-center">
      ...
      <h2 class="section-title">Czym mo\u017Cemy <em>Ci pom\xF3c</em></h2>
      <p class="section-desc">Kompleksowa obs\u0142uga prawna w sprawach rodzinnych \u2014 od pierwszej rozmowy do prawomocnego wyroku.</p>
    </div>
    <div class="services-grid">
      <div class="service-card"><div class="service-num">01</div><h3>Rozw\xF3d</h3><p>Pozew, reprezentacja przed s\u0105dem, negocjacje. Sprawy polubowne i sporne.</p><div class="service-tags"><span class="tag">Z orzekaniem o winie</span><span class="tag">Bez orzekania</span><span class="tag">Separacja</span></div></div>
      <div class="service-card"><div class="service-num">02</div><h3>Podzia\u0142 maj\u0105tku</h3><p>Analiza maj\u0105tku wsp\xF3lnego, negocjacje, reprezentacja s\u0105dowa lub notarialna.</p><div class="service-tags"><span class="tag">Nieruchomo\u015Bci</span><span class="tag">Firmy</span><span class="tag">Kredyty</span></div></div>
      <div class="service-card"><div class="service-num">03</div><h3>Opieka i alimenty</h3><p>Plan wychowawczy, alimenty, prawo do kontakt\xF3w. Zmiana ustalonych warunk\xF3w.</p><div class="service-tags"><span class="tag">Plan wychowawczy</span><span class="tag">Alimenty</span><span class="tag">Kontakty</span></div></div>
    </div>
  </div>
</section>
...
<section class="section" id="opinie">
  <div class="container">
    ...
    <div class="testimonials-grid">
      <div class="testimonial"><div class="t-stars">\u2605\u2605\u2605\u2605\u2605</div><p class="t-quote">\u201EProfesjonalizm i spok\xF3j \u2014 przez ca\u0142y czas mia\u0142em poczucie, \u017Ce wszystko jest pod kontrol\u0105. Serdecznie polecam."</p><div class="t-author"><div class="t-avatar">MK</div><div><div class="t-name">Marek K.</div><div class="t-meta">Sprawa rozwodowa \xB7 Warszawa</div></div></div></div>
      <div class="testimonial"><div class="t-stars">\u2605\u2605\u2605\u2605\u2605</div><p class="t-quote">\u201EPani mecenas skutecznie zawalczy\u0142a o moje prawa. Warunki, kt\xF3re ustalili\u015Bmy, s\u0105 dobre dla ca\u0142ej rodziny."</p><div class="t-author"><div class="t-avatar">AW</div><div><div class="t-name">Anna W.</div><div class="t-meta">Opieka nad dzie\u0107mi \xB7 Legionowo</div></div></div></div>
      <div class="testimonial"><div class="t-stars">\u2605\u2605\u2605\u2605\u2605</div><p class="t-quote">\u201ESprawny kontakt, zawsze dost\u0119pni. Podzia\u0142 maj\u0105tku zako\u0144czony szybciej ni\u017C my\u015Bla\u0142em."</p><div class="t-author"><div class="t-avatar">PT</div><div><div class="t-name">Piotr T.</div><div class="t-meta">Podzia\u0142 maj\u0105tku \xB7 \u0141omianki</div></div></div></div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="faq-layout">
      ...
      <div class="faq-list">
        ...
        <div class="faq-item"><button class="faq-btn">Czy mog\u0119 uzyska\u0107 rozw\xF3d bez orzekania o winie?<span class="faq-icon">+</span></button><div class="faq-body"><p>Tak \u2014 je\u015Bli obie strony si\u0119 zgadzaj\u0105. To szybsze i ta\u0144sze rozwi\u0105zanie. Doradzimy kt\xF3ra opcja jest lepsza w Twoim przypadku.</p></div></div>
        <div class="faq-item"><button class="faq-btn">Co z mieszkaniem i kredytem hipotecznym?<span class="faq-icon">+</span></button><div class="faq-body"><p>Podzia\u0142 maj\u0105tku \u2014 w tym nieruchomo\u015Bci i kredyt\xF3w \u2014 mo\u017Ce by\u0107 przeprowadzony w trakcie lub po sprawie. Mo\u017Cliwe scenariusze: sprzeda\u017C, sp\u0142ata jednego ma\u0142\u017Conka lub wsp\xF3\u0142w\u0142asno\u015B\u0107.</p></div></div>
        <div class="faq-item"><button class="faq-btn">Czy mog\u0119 skonsultowa\u0107 si\u0119 online?<span class="faq-icon">+</span></button><div class="faq-body"><p>Tak. Konsultacje przez Teams, Zoom lub telefon dla klient\xF3w z ca\u0142ej Polski. Pierwsza konsultacja 30 minut bezp\u0142atna.</p></div></div>
      </div>
    </div>
  </div>
</section>
...
<section class="contact-section" id="kontakt">
  <div class="container">
    <div class="section-header section-center text-center">
      ...
      <h2 class="section-title">Zr\xF3b pierwszy krok<br><em>w swoim tempie</em></h2>
    ...
    <form id="contact-form" class="form-card" onsubmit="submitLead(event)">
      <div class="form-card-title">Um\xF3w bezp\u0142atn\u0105 konsultacj\u0119</div>
      ...
      <div class="form-group"><label for="temat">Czego dotyczy sprawa?</label>
        <select id="temat" name="temat">
          ...
          <option>Rozw\xF3d bez orzekania o winie</option>
          <option>Rozw\xF3d z orzeczeniem o winie</option>
          <option>Podzia\u0142 maj\u0105tku wsp\xF3lnego</option>
          <option>Opieka nad dzie\u0107mi / alimenty</option>
          <option>Separacja prawna</option>
          <option>Inne</option>
        </select>
      </div>
      <div class="form-group"><label for="wiadomosc">Kr\xF3tki opis sytuacji</label><textarea id="wiadomosc" name="wiadomosc"></textarea></div>
      <button type="submit" class="form-submit">Wy\u015Blij i um\xF3w konsultacj\u0119 \u2192</button>
      <p class="form-notice">\u{1F512} Dane s\u0105 bezpieczne i chronione. Przetwarzamy je wy\u0142\u0105cznie w celu obs\u0142ugi zapytania.</p>
      <div id="form-success" style="display:none;text-align:center;padding:1.5rem 0;">
        ...
        <p style="font-size:.9rem;color:var(--text-muted)">Oddzwonimy wkr\xF3tce.</p>
      </div>
    </form>
    <div style="text-align:center;margin-top:2.5rem;display:flex;gap:2rem;justify-content:center;flex-wrap:wrap;">
      <a href="tel:+48605089552" class="btn btn-white btn-lg">\u{1F4DE} 605 089 552</a>
...
<footer>
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-col"><h5>Us\u0142ugi</h5><ul><li><a href="#pomoc">Rozw\xF3d</a></li><li><a href="#pomoc">Podzia\u0142 maj\u0105tku</a></li><li><a href="#pomoc">Opieka nad dzie\u0107mi</a></li><li><a href="#pomoc">Alimenty</a></li></ul></div>
      ...
      <div class="footer-col"><h5>Inne dzielnice</h5><ul>
        ...
        <li><a href="https://rozwodmokotow.pl">Mokot\xF3w</a></li>
  ...
  <div class="footer-bottom">
    <div class="container" style="display:flex;justify-content:space-between;flex-wrap:wrap;gap:.5rem">
      <span>\xA9 2025 Kancelaria Adwokacka Magdalena Idzik-Cie\u015Bla. Wszelkie prawa zastrze\u017Cone.</span>
      <span><a href="/polityka-prywatnosci" style="color:inherit">Polityka prywatno\u015Bci</a> \xB7 <a href="/rodo" style="color:inherit">RODO</a></span>
    </div>
  </div>
</footer>
...
async function submitLead(e) {
  ...
  try {
    ...
    if (data.ok) {
      ...
      btn.disabled = false;
      btn.textContent = 'B\u0142\u0105d \u2014 spr\xF3buj ponownie';
      setTimeout(() => { btn.textContent = 'Wy\u015Blij i um\xF3w konsultacj\u0119 \u2192'; }, 3000);
    }
  } catch {
    btn.disabled = false;
    btn.textContent = 'B\u0142\u0105d \u2014 spr\xF3buj ponownie';
...
const DISTRICTS = [
  ...
  { name: "Mokot\xF3w",   url: "https://rozwodmokotow.pl",    key: "mokotow" },
